    	...
    	<col class="cardRecordWidth">
            ...
            <tbody>
                <tr class="dataTable">
                    ...
                    <td class="dataTable"> <?php echo $LocationInfoResults["LocationName"];?> </td>
                </tr>
                <tr class="dataTable">
                    <th class="dataTable"> Building: </th>
                    <td class="dataTable">  <?php echo $LocationInfoResults["Building"];?> </td>
                </tr>
                <tr class="dataTable">
                    <th class="dataTable"> Address: </th>
                    <td class="dataTable"> <?php echo $LocationInfoResults["Address"];?> </td>
                </tr>
                <tr class="dataTable">
                    <th class="dataTable"> Room </th>
                    <td class="dataTable"> <?php echo $LocationInfoResults["Room"];?>
                    </td>
                </tr>
                <tr class="dataTable">
                        ...
                        <ul>
                            <?php
                                ...
                                while($inventory = mysqli_fetch_assoc($inventoryResults)){
                                    ...
                                    echo $inventory["Company_Name"] . " " 
                                            . $inventory["Model"];
                                    if(isset($inventory["Friendly_Name"])) {
                                            echo " \"" . $inventory["Friendly_Name"] . "\"";
                                    }
                                    echo " (Item Number: " .sprintf('%05d', $inventory["ItemID"]) . ")";
                                    echo "</a>";
                                    echo "</li>";
                                }
                            ?>
